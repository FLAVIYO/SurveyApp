...
const DataModel = require('./models/data'); // Import your Data model
...
app.get("/api/survey-data", (req, res) => {
  // Retrieve survey data from the database and format it as needed
  DataModel.find()
    .then((data) => {
      const surveyData = {
...
// Helper functions to calculate survey data
